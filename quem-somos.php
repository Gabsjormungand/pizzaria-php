...
<body>
    <div class="container">
        <header class="row cabecalho p-3">
            <div class="col">
                <img src="logotipo.fw.png" alt="Super pizza" class="img-fluid">
            </div>
            <div col text-end>
